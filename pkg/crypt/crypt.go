...
import (
	...
	"go-postfixadmin/pkg/crypt/common"
)
...
const (
	APR1   Crypt = 1 + iota // import go-postfixadmin/pkg/crypt/apr1_crypt
	MD5                     // import go-postfixadmin/pkg/crypt/md5_crypt
	SHA256                  // import go-postfixadmin/pkg/crypt/sha256_crypt
	SHA512                  // import go-postfixadmin/pkg/crypt/sha512_crypt
	maxCrypt
)
